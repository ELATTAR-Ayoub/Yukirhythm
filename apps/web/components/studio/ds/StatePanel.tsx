            ...
            {states.map((state) => (
              <button
                ...
                className={cn(
                  ...
                  state === active
                    ? "bg-ink text-snow border-ink dark:bg-snow dark:text-ink dark:border-snow"
                    : "bg-transparent text-muted-foreground border-border hover:border-ink/40 dark:hover:border-snow/40"
                )}
              >
                {state}
              </button>
