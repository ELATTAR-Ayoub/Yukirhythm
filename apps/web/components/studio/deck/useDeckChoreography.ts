...
export function useDeckChoreography({
  ...
  const swap = useCallback(
    (dir: SwapDirection) => {
      ...
      t.to(
        arm.position,
        { z: ARM_POSES.up.posZ, duration: 0.22, ease: "power2.out" },
        0
      );
      t.to(
        arm.rotation,
        { z: ARM_POSES.out.rotZ, duration: 0.42, ease: "power2.inOut" },
        0.08
      );
      t.to(
        arm.position,
        { z: ARM_POSES.out.posZ, duration: 0.3, ease: "power2.inOut" },
        0.14
      );
      ...
      t.to(
        out.root.position,
        { y: 0.55, duration: 0.32, ease: "power2.out" },
        0.28
      );
      t.to(
        out.root.scale,
        { x: 1.1, y: 1.1, z: 1.1, duration: 0.32, ease: "power2.out" },
        0.28
      );
      ...
      t.to(
        out.root.position,
        { y: outSlot.pos[1] + 0.4, duration: 0.3, ease: "power1.out" },
        0.62
      );
      t.to(
        out.root.position,
        { y: outSlot.pos[1], duration: 0.34, ease: "power1.in" },
        0.92
      );
      t.to(
        out.root.rotation,
        { y: outSlot.rotY, duration: 0.6, ease: "power2.inOut" },
        0.62
      );
      t.to(
        out.root.scale,
      ...
      t.to(
        inc.root.position,
        { x: 0, z: 0, duration: 0.6, ease: "power2.inOut" },
        0.56
      );
      t.to(
        inc.root.position,
        { y: 0.5, duration: 0.45, ease: "power2.out" },
        0.56
      );
      t.to(
        inc.root.rotation,
        { y: 0, duration: 0.58, ease: "power2.inOut" },
        0.56
      );
      t.to(
        inc.root.scale,
        { x: 1.09, y: 1.09, z: 1.09, duration: 0.58, ease: "power2.inOut" },
        0.56
      );
      t.to(
        inc.spinner.rotation,
        {
          y: seatRotation(inc.spinner.rotation.y),
          duration: 0.85,
          ease: "power2.out",
        },
        0.56
      ...
      t.to(
        inc.root.position,
        { y: 0, duration: 0.34, ease: "back.out(2.4)" },
        1.24
      );
      t.to(
        inc.root.scale,
        { x: 1, y: 1, z: 1, duration: 0.34, ease: "back.out(2)" },
        1.24
      );
      ...
      discs.current.forEach((h, i) => {
        ...
        t.to(
          h.root.rotation,
          { y: s.rotY, duration: 0.55, ease: "power2.inOut" },
          0.62
        );
        t.to(
          h.root.scale,
      ...
      t.to(
        arm.rotation,
        { z: ARM_POSES.up.rotZ, duration: 0.36, ease: "power2.inOut" },
        1.62
      );
      t.to(
        arm.position,
        { z: ARM_POSES.up.posZ, duration: 0.3, ease: "power2.inOut" },
        1.62
      );
      t.to(
        arm.rotation,
        { z: ARM_POSES.down.rotZ, duration: 0.24, ease: "power3.in" },
        2.0
      );
      t.to(
        arm.position,
        { z: ARM_POSES.down.posZ, duration: 0.24, ease: "power3.in" },
        2.0
      );
