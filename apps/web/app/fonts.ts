...
export const fontPixel = localFont({
  src: [
    {
      path: "../public/fonts/offbit/OffBit-Regular.ttf",
      weight: "400",
      style: "normal",
    },
    {
      path: "../public/fonts/offbit/OffBit-Bold.ttf",
      weight: "700",
      style: "normal",
    },
  ],
...
export const fontPixelDot = localFont({
  src: [
    {
      path: "../public/fonts/offbit/OffBit-Dot.ttf",
      weight: "400",
      style: "normal",
    },
    {
      path: "../public/fonts/offbit/OffBit-DotBold.ttf",
      weight: "700",
      style: "normal",
    },
  ],
