...
const CATEGORIES: {
...
}[] = [
  {
    href: "core",
    title: "Core",
    desc: "Buttons, inputs, cards, rows — the primitives.",
    texture: "tx-k2-vinyl",
  },
  {
    href: "shell",
    title: "Shell & Navigation",
    desc: "PageHeader, BottomTabBar, LibraryRail.",
    texture: "tx-k2-topo",
  },
  {
    href: "player",
    title: "Player",
    desc: "DevicePlayer, MiniPlayerBar, GlobalPlayer states.",
    texture: "tx-k2-horizon",
  },
  {
    href: "content",
    title: "Content",
    desc: "Chips, view toggle, sort, track menu.",
    texture: "tx-k-marble",
  },
  {
    href: "drawers",
    title: "Drawers",
    desc: "AppDrawer, playlist detail, create playlist.",
    texture: "tx-k-silk",
  },
  {
    href: "profile",
    title: "Profile & States",
    desc: "ProfileBadge, menus, stats, auth, gates.",
    texture: "tx-k2-static",
  },
  {
    href: "feedback",
    title: "Feedback",
    desc: "Toasts — position, theming, actions.",
    texture: "tx-k-glitch",
  },
];
